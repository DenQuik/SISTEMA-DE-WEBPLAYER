		...
		foreach($datos as $rows){
			$tabla.='
				<tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="'.$url.$pagina.'&user_id_del='.$rows['usuario_id'].'" class="button is-danger is-rounded is-small" onclick="return confirm(\'¿Desea eliminar el usuario seleccionado?\');">Eliminar</a>
                    </td>
                </tr>
            ';
            $contador++;
